...
export const Footer: React.FC = () => {
  ...
  return (
    <footer ref={footerRef} data-theme-bg="#F5F3EE" className="relative text-[#0A0A0A] pt-24 pb-12 px-6 md:px-12 lg:px-20 border-t border-[#0A0A0A]/[0.08] overflow-hidden transition-colors duration-500">
      <div className="max-w-7xl mx-auto space-y-16 relative z-10">
        {/* Top Footer Grid */}
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-start justify-between">
          {/* Brand Info (5 Cols) */}
          <div className="md:col-span-5 space-y-6">
            <span className="font-hero-display text-2xl font-black text-[#0A0A0A] tracking-tight">
              Webbound<span className="text-[#C5F52A]">.</span>
            </span>
            <p className="font-body-ui text-sm text-[#6B7280] font-light leading-relaxed max-w-sm">
              {SITE_CONFIG.description}
            </p>
            <div className="flex items-center gap-3 text-xs font-mono text-[#0A0A0A] font-semibold">
          ...
          <div className="md:col-span-4 space-y-4">
            <span className="text-xs font-mono uppercase tracking-widest text-[#6B7280] block">
              QUICK NAVIGATION
            </span>
          ...
          <div className="md:col-span-3 space-y-6 flex flex-col items-start md:items-end">
            <button
              onClick={scrollToTop}
              className="group inline-flex items-center gap-3 px-5 py-3 rounded-full bg-white border border-[#0A0A0A]/10 hover:border-[#0A0A0A] text-xs font-mono text-[#0A0A0A] transition-all duration-300 cursor-pointer shadow-sm"
              aria-label="Back to top"
            >
              <span>BACK TO TOP</span>
              <div className="w-6 h-6 rounded-full bg-[#0A0A0A] text-white flex items-center justify-center group-hover:bg-[#C5F52A] group-hover:text-[#0A0A0A] transition-colors">
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="p-3 rounded-full bg-white border border-[#0A0A0A]/10 hover:border-[#0A0A0A] hover:bg-[#C5F52A] text-[#0A0A0A] transition-all shadow-sm"
                aria-label="GitHub"
              >
        ...
        {/* Bottom Copyright */}
        <div className="pt-8 border-t border-[#0A0A0A]/[0.08] flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-mono text-[#6B7280]">
          <span>
